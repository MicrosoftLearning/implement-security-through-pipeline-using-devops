...
1. In the Azure portal, navigate to the resource group **rg-eshoponweb-docker** containing deployed resources and select **Delete resource group** to delete all resources created in this lab.
